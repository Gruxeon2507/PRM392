        ...
        call.enqueue(new Callback<List<Account>>() {
            ...
            public void onResponse(Call<List<Account>> call, Response<List<Account>> response) {
                if (response.isSuccessful()) {
                    ...
                    tvcontent.setText("data load: " + s); } else { Toast.makeText(MainActivity.this, "Response not successful" + response.code(), Toast.LENGTH_SHORT).show(); } } @Override public void onFailure(Call<List<Account>> call, Throwable t) { Toast.makeText(MainActivity.this, "API call failed: " + t.getMessage(), Toast.LENGTH_SHORT).show(); tvcontent.setText("API call failed: " + t.getMessage()); } }); } private void init() { tvcontent = (TextView) findViewById(R.id.tvcontent); btnload = findViewById(R.id.btn_load); btnins = findViewById(R.id.btninsert); btnedit = findViewById(R.id.btnedit); btndel = findViewById(R.id.btndel); lv = findViewById(R.id.lv);